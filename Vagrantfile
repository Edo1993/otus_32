...
MACHINES = {
  :master => {
             :box_name => "centos/7",
             :net => [
                      {ip: '192.168.10.150', adapter: 3, netmask: "255.255.255.0", virtualbox__intnet: "internal-net"},
                     ],
            },
  :slave => {
             :box_name => "centos/7",
             :net => [
                      {ip: '192.168.10.151', adapter: 3, netmask: "255.255.255.0", virtualbox__intnet: "internal-net"},
                     ],
            },
  :backup => {
             :box_name => "centos/7",
             :net => [
                      {ip: '192.168.10.152', adapter: 3, netmask: "255.255.255.0", virtualbox__intnet: "internal-net"},
                     ],
            },
}
